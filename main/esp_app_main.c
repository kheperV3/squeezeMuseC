...
*/
        strcpy(boutons, "[");
        strcat(boutons, "{\"gpio\":36, \"type\":\"BUTTON_LOW\", \"debounce\":200,\"normal\":{\"pressed\":\"ACTRLS_VOLDOWN\"}}");
        strcat(boutons, ",{\"gpio\":39, \"type\":\"BUTTON_LOW\",\"debounce\":200,\"normal\":{\"pressed\":\"ACTRLS_VOLUP\"}}");
        strcat(boutons, "]");
